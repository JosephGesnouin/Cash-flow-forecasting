  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .brand-tag {{
      ...
      background: #00915A; color: white; font-size: 11px; font-weight: 600;
...
<body>
  <div class="container">
    ...
    <header>
      <div>
        <div class="brand-tag">🏦 BNP Paribas Cash Management — treasurer-education demo</div>
    ...
    <footer>
      Produced by <strong>BNP Paribas Cash Management</strong> as a
      treasurer-education demo. Generated by
      <code>tools/build_html_dashboard.py</code> from the synthetic
      dataset in <code>data/</code>. All numbers, customers, suppliers
      and bank IBANs are fictional. For interactive exploration (sliders,
      scenario knobs, variance, drill-down tables) run
